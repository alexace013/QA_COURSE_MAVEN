...
public class TestsSelenium extends LoginFixture {
...
//        log.info("switch to registration page.");
        ...
        if (loginPage.isErrorMessageNotEmptyFields()) {
            ...
            Assert.assertFalse("ERROR is not present", loginPage.isErrorMessageNotEmptyFields());
        }
    ...
    public void test3() {
        ...
        if (loginPage.isErrorMessageEmptyFields()) {
            ...
            Assert.assertFalse("ERROR is not present", loginPage.isErrorMessageEmptyFields());
        }
